...
* [SwiftLint](https://github.com/realm/SwiftLint) ⭐ 19,743 | 🐛 509 | 🌐 Swift | 📅 2026-09-20
...
* [The Composable Architecture](https://github.com/pointfreeco/swift-composable-architecture) ⭐ 14,933 | 🐛 23 | 🌐 Swift | 📅 2026-09-18
...
* [Alamofire](https://github.com/Alamofire/Alamofire) ⭐ 42,418 | 🐛 43 | 🌐 Swift | 📅 2026-09-14 when its feature set justifies the dependency
...
| Project                                                                                                                                                                           | Purpose                                              |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| [SwiftLint](https://github.com/realm/SwiftLint) ⭐ 19,743 \| 🐛 509 \| 🌐 Swift \| 📅 2026-09-20                                                                                   | Enforce selected Swift style and correctness rules   |
...
| [Alamofire](https://github.com/Alamofire/Alamofire) ⭐ 42,418 \| 🐛 43 \| 🌐 Swift \| 📅 2026-09-14                                                                                | Networking features and request abstraction          |
...
| [The Composable Architecture](https://github.com/pointfreeco/swift-composable-architecture) ⭐ 14,933 \| 🐛 23 \| 🌐 Swift \| 📅 2026-09-18                                        | Reducer-based application architecture               |
...
| [Swift Collections](https://github.com/apple/swift-collections) ⭐ 4,504 \| 🐛 73 \| 🌐 Swift \| 📅 2026-09-23                                                                     | Additional data structures                           |
...
* [XcodeGen](https://github.com/yonaskolb/XcodeGen) ⭐ 8,798 | 🐛 405 | 🌐 Swift | 📅 2026-09-13 for generating Xcode projects from specifications.
...
* [awesome-ios](https://github.com/vsouza/awesome-ios) ⭐ 53,442 | 🐛 27 | 🌐 Swift | 📅 2026-08-27
